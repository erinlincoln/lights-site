...
export default function Header() {
  ...
  return (
    <header className='d-flex justify-content-start align-items-center'>
      <Logo size={'xsmall'} />
      <h1 id='header-title' className='ms-2 mt-2 mr-auto'>Apollo</h1>
      
      <div id='profile-dropdown' className='dropdown m-3 mt-4 d-flex align-items-center'>
        <h5 className='text-lowercase'>hello, {user.name}</h5>
        <button className="btn dropdown-toggle mb-2" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></button>
